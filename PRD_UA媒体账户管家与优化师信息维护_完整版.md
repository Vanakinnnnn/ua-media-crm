...
4. **综合搜索**：
   - 搜索范围：账户名称、账户ID、Payment Profile ID、分账模式、DHID、Environment
   - 高亮显示：黄色背景标识匹配关键词
...
5. **综合搜索**：
   - **搜索范围**：Slack名称、内部邮箱、账户管家、媒体邮箱、用户ID（Facebook）、培训平台邮箱
   - **高亮显示**：黄色背景标识匹配关键词
...
| 审批AM | 多选 | 追加模式 | ❌ 不支持角色 |
| 增长负责人 | 多选 | 角色定义 | ❌ 角色来源 |
| 开户申请审批人 | 单选 | 覆盖模式 | ❌ 不支持角色 |
| 权限申请审批人 | 单选 | 覆盖模式 | ❌ 不支持角色 |
| 余额不足通知人 | 多选 | 追加模式 | ❌ 不支持角色 |
| 余额不足通知频道 | 单选 | 手动输入 | ❌ 不支持角色 |
